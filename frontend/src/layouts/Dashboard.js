...
const menuItems = [
  ...
  { text: 'Immeubles', icon: <ApartmentIcon />, path: '/immeubles' },
  { text: 'Appartements', icon: <MeetingRoomIcon />, path: '/appartements' },
  { text: 'Locataires', icon: <PersonIcon />, path: '/locataires' },
